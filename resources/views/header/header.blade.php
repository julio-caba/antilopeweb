        ...
        <div class="nav-item" style="text-align:center;">
            <div class="container">                
                <nav class="nav-menu mobile-menu">
                    <ul>
                        <li><a>Categorias</a>
							<ul class="dropdown" style="background-color: #ffa420;">
                            @foreach ($categorias as $categoria)
                                <li><a href="{{ url('/categoria/'.$categoria->id) }}">{{$categoria->name}}</a></li>    						
                            @endforeach
							</ul>
						</li>                   
                        <li><a href="#mas_vendidos">Mas vendidos</a></li>
                        <li><a href="#descubri">Descubri</a></li>
